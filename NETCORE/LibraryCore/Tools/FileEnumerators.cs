...
namespace HouseofCat.LibraryCore
{
    public static class FileEnumerators
    {
        ...
        public static IEnumerable<string> EnumerateFilesInParallel(string path, string searchPattern,
                                                                   SearchOption searchOpt)
        {
            try
            {
        ...
        public static IEnumerable<string> EnumerateFilesInParallelMaxDegree(string path, string searchPattern,
                                                           SearchOption searchOpt)
        {
            try
            {
        ...
        public static IEnumerable<string> EnumerateFilesInParallelMaxDegreeForced(string path, string searchPattern,
                                                   SearchOption searchOpt)
        {
            try
            {
        ...
        public static async Task<IEnumerable<string>> GetFilesInQueueParallelAsync(string path, string searchPattern)
        {
        ...
        public static async Task<IEnumerable<string>> GetFilesInConcurrentParallelAsync(string path, string searchPattern)
        {
            var t = await Task.Run(() =>
            {
                var bag = new ConcurrentBag<string>();
        ...
        public static async Task<IEnumerable<string>> GetFilesInStackParallelAsync(string path, string searchPattern)
        {
            var t = await Task.Run(() =>
            {
                var bag = new ConcurrentBag<string>();
        ...
        public static void QueueParallelTreeTraverse(string root, string searchPattern, Action<string> action)
        {
            int fileCount = 0;
        ...
        public static void StackParallelTreeTraverse(string root, string searchPattern, Action<string> action)
        {
            int fileCount = 0;
            int procCount = Environment.ProcessorCount;
        ...
        #region FastDirectory & FastFileInfo

        public static async Task<IEnumerable<FileData>> EnumerateFilesFastv1Async(string rootPath, string searchPattern, SearchOption searchOption)
        {
            var t = await Task.Run(() =>
            {
                return FastDirectoryEnumerator.EnumerateFiles(rootPath, searchPattern, searchOption); ;
            });
